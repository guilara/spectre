...
@click.option(
    ...
    help="Coordinates of the start of the line through the volume data.",
)
@click.option(
    "--line-end",
    "-B",
    callback=_parse_point,
    help="Coordinates of the end of the line through the volume data.",
)
@click.option(
    "--num-threads",
    "-j",
...
def plot_along_line_command(
    ...
    line_parameter = np.linspace(0, 1, 200)
