 ...
 */
class MinkowskiScalarWave : /* public evolution::initial_data::InitialData, */
 ...
 public:
  ...
  /// \cond
  explicit MinkowskiScalarWave(CkMigrateMessage* msg);
  using PUP::able::register_constructor;
  WRAPPED_PUPable_decl_template(MinkowskiScalarWave);
  /// \endcond
...
bool operator!=(const MinkowskiScalarWave& lhs, const MinkowskiScalarWave& rhs);
