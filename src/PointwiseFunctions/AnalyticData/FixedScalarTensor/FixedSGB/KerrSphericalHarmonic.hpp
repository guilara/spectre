...
#include "PointwiseFunctions/AnalyticData/FixedScalarTensor/FixedSGB/AnalyticData.hpp"
...
class KerrSphericalHarmonic
 ...
 public:
  ...
  using options = tmpl::list<Mass, Spin, Center, Velocity, Amplitude,
                             AmplitudeOfDriver, Radius, Width, Mode>;
  static constexpr Options::String help = {
  ...
  template <typename DataType>
  auto variables(const tnsr::I<DataType, 3>& x,
                 tmpl::list<fe::ScalarTensorDriver::Tags::PiScalar> /*meta*/)
      const -> tuples::TaggedTuple<fe::ScalarTensorDriver::Tags::PiScalar>;

  template <typename DataType>
  auto variables(const tnsr::I<DataType, 3>& x,
                 tmpl::list<fe::ScalarTensorDriver::Tags::TensorDriver<
                     DataType, 3_st>> /*meta*/) const
      -> tuples::TaggedTuple<
          fe::ScalarTensorDriver::Tags::TensorDriver<DataType, 3_st>>;
