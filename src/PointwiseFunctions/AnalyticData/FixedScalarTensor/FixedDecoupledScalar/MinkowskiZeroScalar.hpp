...
class MinkowskiZeroScalar : public virtual evolution::initial_data::InitialData,
 ...
 public:
  ...
  /// The amplitude of the scalar field
  struct AmplitudeDriver {
    using type = double;
    static constexpr Options::String help = {
        "The amplitude of the driver field."};
  };

  using options = tmpl::list<Amplitude, AmplitudeDriver>;
  static constexpr Options::String help = {
  ...
  MinkowskiZeroScalar(double amplitude, double amplitude_driver);
 ...
 protected:
  ...
  double amplitude_driver_ = std::numeric_limits<double>::signaling_NaN();
