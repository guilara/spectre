...
#include "PointwiseFunctions/AnalyticData/FixedScalarTensor/FixedDecoupledScalar/AnalyticData.hpp"
...
class SphericalKerrSchildSH
 ...
 public:
  ...
  SphericalKerrSchildSH() = default;
  SphericalKerrSchildSH(const SphericalKerrSchildSH& /*rhs*/) = default;
  SphericalKerrSchildSH& operator=(const SphericalKerrSchildSH& /*rhs*/) =
      default;
  SphericalKerrSchildSH(SphericalKerrSchildSH&& /*rhs*/) = default;
  SphericalKerrSchildSH& operator=(SphericalKerrSchildSH&& /*rhs*/) = default;
  ~SphericalKerrSchildSH() override = default;

  SphericalKerrSchildSH(double mass,
  ...
  /// \cond
  explicit SphericalKerrSchildSH(CkMigrateMessage* msg);
  using PUP::able::register_constructor;
  WRAPPED_PUPable_decl_template(SphericalKerrSchildSH);
  /// \endcond
  ...
  /// @{
  /// Retrieve scalar driver variable at `x`
  template <typename DataType>
  auto variables(const tnsr::I<DataType, 3>& x,
 ...
 protected:
  friend bool operator==(const SphericalKerrSchildSH& lhs,
