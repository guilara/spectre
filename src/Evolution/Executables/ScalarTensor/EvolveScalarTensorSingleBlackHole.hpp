...
//                    ::ah::source_vars<volume_dim>>;
  ...
  // boundary. Every Target gets the same interpolator_source_vars, so they
  // need to be made the same. Otherwise a static assert is triggered.
...
//           typename ExcisionBoundaryA::post_interpolation_callback>>;
  ...
  using initialization_actions =
      tmpl::push_back<tmpl::pop_back<typename st_base::initialization_actions>,
                      intrp::Actions::ElementInitInterpPoints<
                          intrp::Tags::InterpPointInfo<EvolutionMetavars>>,
                      tmpl::back<typename st_base::initialization_actions>>;
