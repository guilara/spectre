...
struct EvolutionMetavars {
  ...
  using initialize_initial_data_dependent_quantities_actions = tmpl::list<
      ...
      Initialization::Actions::AddSimpleTags<
          ...
          fe::sgb::Initialization::InitializeEvolvedScalarVariables>,
  ...
  using const_global_cache_tags = tmpl::list<
      ...
      ScalarTensor::ConstraintDamping::Tags::DampingFunctionGamma2<volume_dim,
                                                                   Frame::Grid>,
      //   fe::sgb::ConstraintDamping::Tags::DampingFunctionGamma1<volume_dim,
      //                                                           Frame::Grid>,
      //   fe::sgb::ConstraintDamping::Tags::DampingFunctionGamma2<volume_dim,
      //                                                           Frame::Grid>,
      // Scalar driver parameters
