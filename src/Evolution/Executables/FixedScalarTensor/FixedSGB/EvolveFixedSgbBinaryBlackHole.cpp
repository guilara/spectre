...
#include "Evolution/Executables/FixedScalarTensor/FixedSGB/EvolveFixedSgbBinaryBlackHole.hpp"
...
#include "Evolution/Systems/FixedScalarTensor/FixedSGB/ConstraintDamping/RegisterDerivedWithCharm.hpp"
...
extern "C" void CkRegisterMainModule() {
  ...
  Parallel::charmxx::register_init_node_and_proc(
      {&domain::creators::register_derived_with_charm,
       ...
       &fe::sgb::BoundaryCorrections::register_derived_with_charm,
       &gh::ConstraintDamping::register_derived_with_charm,
       &ScalarTensor::ConstraintDamping::register_derived_with_charm,
       &fe::sgb::ConstraintDamping::register_derived_with_charm,
