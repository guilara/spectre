 ...
 */
class BjorusAnalyticConstant final : public BoundaryCondition {
 public:
  ...
  static constexpr Options::String help{
      ...
      "Dirichlet boundary conditions for the scalar."};

  BjorusAnalyticConstant() = default;
  explicit BjorusAnalyticConstant(
      gh::BoundaryConditions::detail::ConstraintPreservingBjorhusType type,
      double amplitude_scalar);

  BjorusAnalyticConstant(BjorusAnalyticConstant&&) = default;
  BjorusAnalyticConstant& operator=(BjorusAnalyticConstant&&) = default;
  BjorusAnalyticConstant(const BjorusAnalyticConstant&) = default;
  BjorusAnalyticConstant& operator=(const BjorusAnalyticConstant&) = default;
  ~BjorusAnalyticConstant() override = default;

  explicit BjorusAnalyticConstant(CkMigrateMessage* msg);

  WRAPPED_PUPable_decl_base_template(
      domain::BoundaryConditions::BoundaryCondition, BjorusAnalyticConstant);
