 ...
 public:
  ...
  void set_initial_data(
    ...
    if (std::holds_alternative<NumericInitialData::GhVars>(
      ...
      *pi = std::move(get<gh::Tags::Pi<DataVector, 3>>(*numeric_data));
      ...
      ERROR(
          ...
          "an implementation to ScalarTensor::NumericInitialData.");
    }
...
//            gh::Tags::Pi<DataVector, Dim>, gh::Tags::Phi<DataVector, Dim>>(
  //     &ScalarTensor::initial_gh_variables_from_adm<Dim>, box, spatial_metric,
 ...
 * ScalarTensor::Actions::SetInitialData to wait until the data
    ...
    db::mutate<gr::Tags::SpacetimeMetric<DataVector, 3>,
        ...
        [&initial_data, &numeric_data, &mesh, &inv_jacobian](
          ...
          initial_data.set_initial_data(
              spacetime_metric, pi, phi, psi_scalar, pi_scalar, phi_scalar,
