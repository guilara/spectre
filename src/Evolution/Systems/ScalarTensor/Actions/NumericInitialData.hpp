...
//   using HydroNumericId = grmhd::ValenciaDivClean::NumericInitialData;
 ...
 public:
  ...
  using scalar_vars = tmpl::list<CurvedScalarWave::Tags::Psi,
   CurvedScalarWave::Tags::Pi, CurvedScalarWave::Tags::Phi<3_st>>;
  using all_vars =
      tmpl::append<GhNumericId::all_vars, scalar_vars>;

  struct GhVariables : GhNumericId::Variables {};
//   struct HydroVariables : HydroNumericId::Variables {};
  struct ScalarVariables : tuples::tagged_tuple_from_typelist<
                       db::wrap_tags_in<VarName, scalar_vars>> {
    static constexpr Options::String help =
        "Scalar variables: 'Psi', 'Pi', 'Phi'";
...
// const HydroNumericId& hydro_numeric_id() const { return hydro_numeric_id_; }
  ...
  void scalar_numeric_id_select_for_import(
    ...
    std::visit(
        ...
        // Set in constructior (cpp file)
        scalar_selected_variables_);
  }
  ...
  void select_for_import(
    ...
    // May comment if we don't want to read from file
    // scalar_numeric_id_select_for_import(fields);
  }
  ...
  void set_initial_data(
      ...
      //
      const gsl::not_null<Scalar<DataVector>*> scalar_psi,
      const gsl::not_null<Scalar<DataVector>*> scalar_pi,
      const gsl::not_null<tnsr::i<DataVector, 3>*> scalar_phi,
    ...
    // Set scalar ID
    const size_t num_points = get(*spacetime_metric).size();
    destructive_resize_components(scalar_psi, num_points);
    get(*scalar_psi) = 0.0;
    destructive_resize_components(scalar_pi, num_points);
    get(*scalar_pi) = 0.0;
    destructive_resize_components(scalar_phi, num_points);
 ...
 * ScalarTensor::Actions::ReadNumericInitialData to wait until the
        ...
        //  &equation_of_state
         ...
         // const gsl::not_null<Scalar<DataVector>*> specific_internal_energy,
          ...
          initial_data.set_initial_data(
              ...
              scalar_psi, scalar_pi, scalar_phi,
