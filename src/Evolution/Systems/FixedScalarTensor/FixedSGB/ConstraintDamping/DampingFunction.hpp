...
class DampingFunction : public PUP::able {
 public:
  using creatable_classes = tmpl::conditional_t<
      ...
      tmpl::list<
          fe::sgb::ConstraintDamping::GaussianPlusConstant<VolumeDim, Fr>,
          fe::sgb::ConstraintDamping::TimeDependentTripleGaussian>,
      tmpl::list<
          fe::sgb::ConstraintDamping::GaussianPlusConstant<VolumeDim, Fr>>>;
...
#include "Evolution/Systems/FixedScalarTensor/FixedSGB/ConstraintDamping/TimeDependentTripleGaussian.hpp"
