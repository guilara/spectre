...
class BoundaryCorrection : public PUP::able {
 public:
  ...
  using creatable_classes = typename detail::AllProductCorrections<
      typename ScalarTensor::BoundaryCorrections::BoundaryCorrection::
          creatable_classes,
      typename fe::ScalarTensorDriver::BoundaryCorrections::BoundaryCorrection::
          creatable_classes>::type;
