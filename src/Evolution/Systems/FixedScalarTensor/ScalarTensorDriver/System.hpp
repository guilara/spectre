...
struct System {
  ...
  using variables_tag = ::Tags::Variables<tmpl::list<
      Tags::Psi, Tags::PiScalar, Tags::PhiScalar<3_st>,
      Tags::TensorDriver<DataVector, volume_dim>,
      Tags::Pi<DataVector, volume_dim>, Tags::Phi<DataVector, volume_dim>>>;
  using flux_variables = tmpl::list<>;
  using gradient_variables =
      tmpl::list<Tags::Psi, Tags::PiScalar, Tags::PhiScalar<3_st>,
                 Tags::TensorDriver<DataVector, volume_dim>,
