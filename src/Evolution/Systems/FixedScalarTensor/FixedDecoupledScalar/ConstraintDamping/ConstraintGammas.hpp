...
struct ConstraintGamma1Compute : ::fe::ScalarDriver::Tags::ConstraintGamma1,
                                 db::ComputeTag {
  using argument_tags =
  ...
  using base = ::fe::ScalarDriver::Tags::ConstraintGamma1;
};
 ...
 */
template <size_t SpatialDim, typename Frame>
struct ConstraintGamma2Compute : ::fe::ScalarDriver::Tags::ConstraintGamma2,
                                 db::ComputeTag {
  using argument_tags =
