...
class ProductOfCorrections final : public BoundaryCorrection {
 public:
  ...
  double dg_package_data(
      ...
      gsl::not_null<Scalar<DataVector>*> packaged_v_psi_scalar_driver,
      gsl::not_null<tnsr::i<DataVector, 3_st, Frame::Inertial>*>
  ...
  void dg_boundary_terms(
      ...
      // Scalar boundary corrections
      gsl::not_null<Scalar<DataVector>*> psi_boundary_correction_scalar_driver,
      gsl::not_null<Scalar<DataVector>*> pi_boundary_correction_scalar_driver,
      gsl::not_null<tnsr::i<DataVector, 3_st, Frame::Inertial>*>
